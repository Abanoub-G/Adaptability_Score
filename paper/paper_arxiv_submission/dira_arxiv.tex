...
\title{DIRA: \textbf{D}ynamic Domain \textbf{I}ncremental \textbf{R}egularised \textbf{A}daptation}
\titlerunning{Dynamic Domain Incremental ...}
\authorrunning{Ghobrial et al.}

\author{Abanoub Ghobrial\inst{1}, Xuan Zheng\inst{1}, Darryl Hond\inst{2}, Hamid Asgari\inst{2}, Kerstin Eder\inst{1}}
