...
# experiment_id_array = [104, 105, 106,108]#[66, 64, 45, 41]

# experiment_id_array = [114, 111, 112, 113] # resnet-18 (CIFAR-10C)
# experiment_id_array = [106, 104 ,105,109]#108] # resnet-26 (CIFAR-10C) DIRA with CAS
experiment_id_array = [106, 104 ,105,121]#108] # resnet-26 (CIFAR-10C) DIRA without CAS
# experiment_id_array = [115,116, 117, 118] # resnet-26 (CIFAR-100C) DIRA with CAS
# experiment_id_array = [115,116, 117, 123] # resnet-26 (CIFAR-100C) DIRA without CAS
...
for experiment_id in experiment_id_array:
	...
	if experiment_id == 109 or experiment_id == 108 or experiment_id == 100 or experiment_id == 103 or experiment_id == 113 or experiment_id == 118 or experiment_id == 121 or experiment_id == 123:
		label_name = "DIRA"
		color_name = "blue"
		linestyle  = "-"
	
	elif experiment_id == 41 or experiment_id == 105 or experiment_id == 112 or experiment_id == 115:
		label_name = "SGD ($\eta$ = 1e-5)"
		color_name = "orange"
		linestyle  = "-"

	elif experiment_id == 45 or experiment_id == 104 or experiment_id == 111 or experiment_id == 116:
		label_name = "SGD ($\eta$ = 1e-3)"
		color_name = "orange"
		linestyle  = "-."

	elif experiment_id == 64 or experiment_id == 106 or experiment_id == 114  or experiment_id == 117:
	...
	# elif experiment_id == 121 :
	# 	label_name = "DIRA_without_CAS"
	# 	color_name = "red"
	# 	linestyle  = "-"
...
plt.savefig(results_folder+"/CIFAR10C_Resnet26_N_TvsA_T.pdf")
# input("wait")
...
plt.ylabel("Top-1 Classification Accuracy (%)")
plt.savefig(results_folder+"/DynamicScenario_ResNet26_CIFAR10C.pdf")
...
# plt. clf()
# # plt.plot([0, 600], [Baseline_accuracy*100, Baseline_accuracy*1Z00], label="Baseline CIFAR-10", linestyle="--", color="grey")
