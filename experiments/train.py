...
def main():
    ...
    # train_set = datasets.CIFAR10(DATASET_DIR, download=True, train=True, transform=transform)
    # trainloader = torch.utils.data.DataLoader(train_set, batch_size=64, shuffle=True)

    # test_set = datasets.CIFAR10(DATASET_DIR, download=True, train=False, transform=transform)
